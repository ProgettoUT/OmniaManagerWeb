...
Public Class FormImportaSinistri
    ...
    Private Sub ImpostaControlli()
        ...
        With ButtonAggiorna
            ...
            .Text = "Aggiorna i sinistri per utente e data"
        End With
    ...
    Private Sub ImportaSinistri()
        Try
            ...
            Dim Utente, Password As String
            Utente = Utx.Globale.UtenteCorrente.UniageUser
            Password = Utx.Globale.UtenteCorrente.UniagePw
            ...
            Using setting As New Utx.SettingAgenzia.ConfiguraSede
                ...
                Dim Risposta As Utx.ImportaSinistriOMW.InfoSinistriRisposta
                Using s As New Utx.ImportaSinistriOMW.Direzione
                    s.Proxy = Utx.Globale.UniProxy.Proxy
                    Risposta = s.ListaSinistri(Utente, Password, dtpDal.Value, dtpAl.Value)
                End Using
                ...
                Dim Totali As Integer = Risposta.InfoSinistri.Length
                ...
                If Totali > 0 Then
                    ...
                    For Each Agenzia As String In Utx.EnteGestore.CodiciGestiti
                        ...
                        For Each Incorporata As String In CodiciIncorporati.Split("/")
                            ...
                            For Each Sinistro In Risposta.InfoSinistri
    ...
    Private Function AddSinistro(Dettaglio As Utx.ImportaSinistriOMW.DettaglioSinistro, ByRef dt As DataTable) As Boolean
        Try
            ...
            With Dettaglio
                ...
                'assicurato
                dr("CODICEFISCCONTRPOL") = .CodiceFiscaleContraente
                ...
                dr("CodiceLiquidatore") = .LiquidatoreAssegnatario
    ...
    Private Sub ButtonAggiorna_Click(sender As Object, e As EventArgs) Handles ButtonAggiorna.Click
        ...
        If DateDiff(DateInterval.Day, dtpDal.Value, dtpAl.Value) > 7 Then
            MsgBox("l'intervallo non può superare i sette giorni.", MsgBoxStyle.Critical, Utx.Globale.TitoloApp)
            Exit Sub
        End If
        ImportaSinistri()
    End Sub
