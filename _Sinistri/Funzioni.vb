...
#Region "statistiche"
    ...
    Public Function FrequenzaPerRamoProdotto(Optional Descrizione As Windows.Forms.Label = Nothing) As DataTable
        Try
            Dim Risposta As Utx.ServiziOMW.Risposta = Utx.WsCommand.ExecuteScalar("SELECT Max(UltimoAggiornamento) FROM CalendarioOmnia WHERE TipoFile = '07'")
            ...
            Dim Q1 As String = "SELECT STR(RamoPolizza) AS Ramo,S.CodiceProdotto,
                ...
                "ON S.RamoPolizza = P.Ramo AND CAST(S.CodiceProdotto AS Int) = CAST(P.CodiceProdotto AS Int) " +
    ...
    Public Function StatisticheLiquidato() As DataTable
        Try
            Dim sql As String = "SELECT FORMAT(S.RamoSinistro,'00') + '.' + TR.DesRamoSinistro AS RamoSinistro,EsercizioSinistro,
                ...
                WHERE(S.TipoCid LIKE '[ 12345678]') AND (S.StatoBilancistico = 'LT') AND (EsercizioSinistro >= 2010) 
