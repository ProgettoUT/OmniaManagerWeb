Namespace P01263
    Public Class P01263FE
        ...
        Public Sub New()
            ...
            Me.QuotatorePremio.Image = Global.UniQuota.My.Resources.Resources.P01263
            Me.docBrowser.Tag = "http://www.utools.it/Unitools/Doc/Prodotti/P01263/IndexDoc.htm"
            Me.docBrowser.Url = New System.Uri(Me.docBrowser.Tag, System.UriKind.Absolute)

            'preventivo = New Ricovero
            'modello = New P01263ST

            Dim decode As New P01263DE
            'preventivo.Decode = decode
            Me.decode = decode

            helpChm.CodiceProdotto = "P01263"
        ...
        Protected Overrides Sub ControlsToPreventivo(ByVal diretto As Boolean)
            With TryCast(preventivo, Ricovero)
        ...
        Private Sub TabControl1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
            If TabControl1.SelectedTab.Equals(TabAgg) Then
                ...
                TryCast(preventivo, Ricovero).Aggiungiassicurato(assicurato)
                preventivo.ValidaECalcola()
                PreventivoToControls()
            End If
        End Sub
        ...
        Private Sub RimuoviScheda(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            TryCast(preventivo, Ricovero).Rimuoviassicurato(assicuratoFE.assicurato)
            preventivo.ValidaECalcola()
            PreventivoToControls()
        ...
        Public Overrides Sub Apri(ByVal p As Prodotto)
            If p IsNot Nothing Then
                ...
                For Each assicurato As assicurato In TryCast(preventivo, Ricovero).assicurati
                    AggiungiScheda(assicurato)
                Next
