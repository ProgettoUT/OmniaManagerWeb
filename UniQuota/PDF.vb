...
Public Class Pdf
    ...
    Public Sub SetColorStroke(ByVal rgb As Int32)
        ...
        End If
    End Sub
    Public Sub SetColorFill(ByVal color As Color)
    ...
    '
    Public Sub DrawRect(ByVal x1 As Single, ByVal y1 As Single, _
    ...
    ByVal FileImg As BinaryReader, _
    ...
    Public Function LoadImgFromBMPRecources(ByVal Name As String, _
    ByVal RecourceName As String, _
    Optional ByVal ColorSpace As pdfColorSpace = pdfColorSpace.pdfRGB) As Boolean
    ...
    Public Function ChangePixelFormat(ByVal inputImage As Bitmap, ByVal newFormat As PixelFormat) As Bitmap
    ...
    End Function
    '
    Private Sub FileGet(ByVal fb As BinaryReader, ByRef campo As Byte())
        campo = fb.ReadBytes(campo.Length)
    End Sub

    Private Sub FileGet(ByVal fb As BinaryReader, ByRef campo As Int16)
        campo = fb.ReadInt16()
    End Sub

    Private Sub FileGet(ByVal fb As BinaryReader, ByRef campo As Int32)
        campo = fb.ReadInt32()
    End Sub

    Private Function LeggeBMP(ByVal fb As BinaryReader, _
     ByRef ImgBuf() As Byte, _
     ByRef ImgColor() As Byte, _
