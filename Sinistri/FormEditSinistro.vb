...
Public Class FormEditSinistro
    ...
    Public WithEvents Evento As New EventoLiquido
    ...
    Private Sub FormEditSinistro_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ...
        Evento.LeggiPaginaEvento()
    End Sub

    Private Sub InitSinistro() Handles Evento.LetturaEventoCompletata
        Try
            With Evento
    ...
    Private Sub rbAltraCompagnia_Click(sender As Object, e As EventArgs) Handles rbAltraCompagnia.Click
        ...
        Try
            ...
            Dim Sql As String = $"SELECT MAX(NumeroSinistro) AS Numero 
                FROM SinistriAC 
                WHERE EsercizioSinistro = {TextBoxEsercizio.Text} AND AgenziaSinistro < 10"
            Dim Risposta As Utx.ServiziOMW.Risposta = Utx.WsCommand.ExecuteScalar(Sql)
            If Risposta.Valore Is DBNull.Value Then
                TextBoxNumero.Text = 1
            Else
