...
Public Class FormMainKMS
    ...
    Private Sub frmMain_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
        Try
            ...
            If Not EsisteTabellaQt("MonitorQt_KMS") Then
    ...
    Private Sub ImpostaControlli()
        ...
        lbTipoVeicolo.Text = ""
        lbTasse.Text = ""
        lbDeskStatistiche.Text = "Incassato auto, nel periodo e per le figure selezionate, su quietanze (tipo carico 4)." + _
    ...
    Private Sub dgv1_CellFormatting(sender As Object, e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dgv1.CellFormatting
        ...
        Select Case e.ColumnIndex
            Case dgv1.Columns("CVTPercRata").Index, dgv1.Columns("PercDiffTotRata").Index
                If e.Value > 0 Then
                    e.CellStyle.Font = Utx.AppFont.Bold
                    e.CellStyle.BackColor = Color.LightSalmon
                Else
                    e.CellStyle.Font = Utx.AppFont.Normal
                End If
    ...
    Private Sub dgv1_CurrentCellDirtyStateChanged(sender As Object, e As EventArgs) Handles dgv1.CurrentCellDirtyStateChanged
        If dgv1.IsCurrentCellDirty Then
            ...
            da.UpdateCommand = cmdUpdateCheck(dgv1.CurrentRow.Cells("Polizza").Value, _
    ...
    Private Sub FormattaColonne(ByRef dgv As DataGridView)
        ...
        With dgv
            ...
            .Columns("CVTRataLordoOld").HeaderText = "Tot.CVT di Rata lordo Old"
            .Columns("CVTRataLordoNew").HeaderText = "Tot.CVT Di Rata lordo New"
            .Columns("TotDiffArd").HeaderText = "Diff.ARD di rata"
            .Columns("CVTPercRata").HeaderText = "Diff.ARD di rata %"
            ...
            .Columns("CanoneOffTelRataOld").HeaderText = "Unibox Old"
            .Columns("CanoneOffTelRataNew").HeaderText = "Unibox New"
            .Columns("PercDiffRcaRata").HeaderText = "Diff.RCA di rata %"
            .Columns("MaxOld").HeaderText = "Max Old"
            .Columns("MaxNew").HeaderText = "Max New"
            .Columns("ValoreIFOld").HeaderText = "Valore IF"
            .Columns("CFContraente").HeaderText = "CF contraente"
            ...
            .Columns("PercFlexOld").HeaderText = "Flex Old"
            .Columns("PercPlaf").HeaderText = "Sconto Plaf.%"
            ...
            Dim ColCentra As String = "Contraente;CFContraente;Proprietario;CFProprietario;FormaTariffaNew;OpzioneTariffaOld"
            ...
            Dim ColEuro As String = "TotRataLordoOld;CanoneOffTelRataOld;TotRataLordoNew;CanoneOffTelRataNew;TotDiff;" +
                                    "RcaLordoForzata;CVTRataLordoOld;CVTRataLordoNew;TotDiffArd;ValoreIFOld;" +
            ...
            Dim ColPerc As String = "PercDiffTotRata;PercDiffRca;CVTPercRata;PercFlexRca;PercFlexOld;" + _
                                    "PercPlaf;PercScontoConv;PercDiffRcaRata;PercFlexIF"
            ...
            'blocca l'ordinamento (possibile solo da codice con filtro)
            Utx.NetFunc.BloccaOrdinamento(dgv1)
    ...
    Private Sub AllineaLinkLabel()
        On Error Resume Next
        LinkLabelPannello.Location = New Point(TabQuietanze.Left + TabQuietanze.Width - LinkLabelPannello.Width, _
                                               SplitMain.Top)
        LinkLabelDettaglio.Location = New Point(LinkLabelPannello.Left - LinkLabelDettaglio.Width - 10, _
    ...
    Private Sub InizializzaBinding()
        ...
        With lbConvenzione.DataBindings
            .Clear()
            .Add("Text", bs, "ConvNew")
        End With
        'quietanza old
        With txtRcaOld.DataBindings
            .Clear()
            .Add("Text", bs, "RcaLordoRataOld", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtIFOld.DataBindings
            .Clear()
            .Add("Text", bs, "IFLordoOld", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtKaskoOld.DataBindings
            .Clear()
            .Add("Text", bs, "KASLordoOld", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtArdOld.DataBindings
            .Clear()
            .Add("Text", bs, "AltroARDLordoOld", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        'With txtUniboxOld
        '    .DataBindings.Clear()
        '    .DataBindings.Add("Text", bs, "UniboxOld", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        'End With
        'With txtFlexOld
        '    .DataBindings.Clear()
        '    .DataBindings.Add("Text", bs, "FlexOld", True, DataSourceUpdateMode.Never, "", "##0.00")
        'End With
        'With txtBonus
        '    .DataBindings.Clear()
        '    .DataBindings.Add("Text", bs, "BonusFedelta", True, DataSourceUpdateMode.Never, "", "Bonus ##0")
        'End With
        'quietanza new
        With txtRca.DataBindings
            .Clear()
            .Add("Text", bs, "RcaLordoRataNew", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtIF.DataBindings
            .Clear()
            .Add("Text", bs, "IFLordoNew", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtKasko.DataBindings
            .Clear()
            .Add("Text", bs, "KASLordoNew", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtArd.DataBindings
            .Clear()
            .Add("Text", bs, "AltroARDLordoNew", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtUnibox.DataBindings
            .Clear()
            .Add("Text", bs, "BoxNettoNew", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        'modifica qt
        With txtRca2.DataBindings
            .Clear()
            .Add("Text", bs, "RcaLordoForzata", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtIF2.DataBindings
            .Clear()
            .Add("Text", bs, "IFLordoForzata", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtKasko2.DataBindings
            .Clear()
            .Add("Text", bs, "KaskoLordoForzata", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtArd2.DataBindings
            .Clear()
            .Add("Text", bs, "AltroARDLordoNew", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        'With txtUnibox2
        '    .DataBindings.Clear()
        '    .DataBindings.Add("Text", bs, "UniboxNew", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        'End With
        With txtFlexRcaPerc.DataBindings
            .Clear()
            .Add("Text", bs, "PercFlexRca", True, DataSourceUpdateMode.Never, "", "##0.00")
        End With
        With txtFlexRcaImporto.DataBindings
            .Clear()
            .Add("Text", bs, "ImportoFlexRca", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtFlexIFPerc.DataBindings
            .Clear()
            .Add("Text", bs, "PercFlexIF", True, DataSourceUpdateMode.Never, "", "##0.00")
        End With
        With txtFlexIFImporto.DataBindings
            .Clear()
            .Add("Text", bs, "ImportoFlexIF", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtFlexKaskoPerc.DataBindings
            .Clear()
            .Add("Text", bs, "PercFlexKasko", True, DataSourceUpdateMode.Never, "", "##0.00")
        End With
        With txtFlexKaskoImporto.DataBindings
            .Clear()
            .Add("Text", bs, "ImportoFlexKasko", True, DataSourceUpdateMode.Never, "", "##,##0.00")
        End With
        With txtFraz.DataBindings
            .Clear()
            .Add("Text", bs, "FrazNew", True, DataSourceUpdateMode.Never, "", "#")
        End With
        With txtFSP.DataBindings
            .Clear()
            .Add("Text", bs, "FspNew", True, DataSourceUpdateMode.Never, "", "!")
        End With
        With lbTipoVeicolo.DataBindings
            .Clear()
            .Add("Text", bs, "TipoVeicolo", True, DataSourceUpdateMode.Never, "", "!")
        End With
        'note
        With txtNote.DataBindings
            .Clear()
            .Add("Text", bs, "Annotazioni", False, DataSourceUpdateMode.Never)
        End With
    End Sub
    ...
    Private Sub btnSalva_Click(sender As System.Object, e As System.EventArgs) Handles btnSalva.Click
        ...
        Try
            ...
            'forza il flag flex
            If dgv1.CurrentRow.Cells("Fatto").Value = True OrElse _
            ...
            da.UpdateCommand = cmdUpdate(dgv1.CurrentRow.Cells("Polizza").Value, _
                                         dgv1.CurrentRow.Cells("Effetto").Value.ToString)
        ...
        Try
            ...
            Using cmd As New OleDbCommand
                ...
                With cmd
                    ...
                    '.CommandText = "UPDATE (((MonitorQT_KMS AS M " +
                    ...
                    '.CommandText = "UPDATE MonitorQT_KMS SET AliquotaRca = 12.5 WHERE AliquotaRca IS NULL"
                    '.ExecuteNonQuery()
                    ...
                    .CommandText = "UPDATE MonitorQt_KMS " +
    ...
    Function Sql() As String
        ...
        Sql = "SELECT Flex,Fatto,Variata,Sostituita,Disdetta," +
                     ...
                     "Effetto," +
                     "Contraente," +
                     "((TotRataLordoNew + CanoneOffTelRataNew) - (TotRataLordoOld + CanoneOffTelRataOld)) AS TotDiff," +
                     "PercDiffTotRata," +
                     "Iif(BOXNettoNew > 0,'S','N') AS UBox," +
                     "MeritoOld," +
                     "FspOld," +
                     "MeritoNew," +
                     "FspNew," +
                     ...
                     "CVTRataLordoOld," +
                     "CVTRataLordoNew," +
                     "(CVTRataLordoOld - CVTRataLordoNew) AS TotDiffArd," +
                     "CVTPercRata," +
                     ...
                     "(CVTRataLordoOld - (INCNettoOld + FURNettoOld) * 1.135 * " + CoeffFraz + " - KASLordoOld) AS AltroARDLordoOld," +
                     "(CVTRataLordoNew - (INCNettoNew + FURNettoNew) * 1.135 * " + CoeffFraz + " - KASLordoNew) AS AltroARDLordoNew," +
                     "Targa," +
                     "TipoVeicolo," +
              ...
              "WHERE " + WhereContraente + " AND " +
                         ...
                         WhereFiltro + " AND " +
                         WhereSaturazione +
              "ORDER BY (TotRataLordoNew + CanoneOffTelRataNew - TotRataLordoOld - CanoneOffTelRataOld) DESC"
    End Function
    ...
    Private Sub ImpostaWhere()
        Try
            ...
            WhereDate = " (Effetto BETWEEN " + DataUSA(dtpInizio.Value) + " AND " + _
            ...
            Select Case Val(cboFiltro.Text)
                ...
                Case 2
                    Try
                        WhereContraente = " (Contraente Like '" + _
                                          dgv1.SelectedRows(0).Cells(dgv1.Columns("Contraente").Index).Value + _
                                          "') "
                    Catch ex As Exception
                        'niente
                    End Try
                ...
                Case 11
                    WhereFiltro = " (Flex = False AND Fatto = False AND Disdetta = False AND " + _
    ...
    Private Sub TotaleQuietanze()
        Try
            'old
            txtSubTotaleRataOld.Text = FormIt(CDbl(txtRcaOld.Text) + _
                                              CDbl(txtIFOld.Text) + _
                                              CDbl(txtKaskoOld.Text) + _
                                              CDbl(txtArdOld.Text))
            txtTotaleRataOld.Text = FormIt(CDbl(txtSubTotaleRataOld.Text) + _
                                           CDbl(txtUniboxOld.Text))
            'new
            txtSubTotaleRata.Text = FormIt(CDbl(txtRca.Text) + _
                                           CDbl(txtIF.Text) + _
                                           CDbl(txtKasko.Text) + _
                                           CDbl(txtArd.Text))
            txtTotaleRata.Text = FormIt(CDbl(txtSubTotaleRata.Text) + _
                                        CDbl(txtUnibox.Text))
        Catch ex As Exception
            'niente
        End Try
    ...
    Private Sub TotaleModifica()
        Try
            'modifica
            txtSubTotaleRata2.Text = FormIt(CDbl(txtRca2.Text) + _
                                            CDbl(txtIF2.Text) + _
                                            CDbl(txtKasko2.Text) + _
                                            CDbl(txtArd2.Text))
            txtTotaleRata2.Text = FormIt(CDbl(txtSubTotaleRata2.Text) + _
    ...
    Private Function cmdUpdate(Polizza As Long, Effetto As String) As OleDbCommand
        ...
        With cmdUpdate
            .CommandText = "UPDATE MonitorQT_KMS " + _
                           "SET RcaLordoForzata = ?," + _
                               "ImportoFlexRca = ?," + _
                               "PercFlexRca = ?," + _
                               "IFLordoForzata = ?," + _
                               "ImportoFlexIF = ?," + _
                               ...
                               "Annotazioni = ?," + _
                               "Flex = ? " + _
                           "WHERE Polizza = " + Polizza.ToString + " And " + _
    ...
    Private Function cmdUpdateCheck(Polizza As Long, Effetto As String) As OleDbCommand
        ...
        With cmdUpdateCheck
            .CommandText = String.Format("UPDATE MonitorQT_KMS " +
    ...
    Private Sub TotaleFlex()
        Try
            ...
            Dim WhereData As String = " Effetto Between " + DataUSA(dtpInizio.Value.ToString) + " And " + _
            ...
            Try
                cmdTotali.CommandText = "SELECT Sum(ImportoFlexRca * FrazNew) " + _
                                        "FROM MonitorQT_KMS " + _
                                        "WHERE Flex = -1 And " + _
                                        WhereData + " And " + _
                                        WhereSub + " And " + _
                                        WhereProd
            ...
            End Try
            Try
                cmdTotali.CommandText = "SELECT Sum((ImportoFlexIF + ImportoFlexKasko) * FrazNew) " + _
                                        "FROM MonitorQT_KMS " + _
                                        "WHERE Flex = -1 And " + _
                                        WhereData + " And " + _
                                        WhereSub + " And " + _
    ...
    Private Sub LabelPeriodo()
        lbPeriodo.Text = "Periodo " + Format(dtpInizio.Value, "dd/MM") + _
                         " - " + Format(dtpFine.Value, "dd/MM") + _
    ...
    Private Sub CalcolaStatistiche()
        ...
        Try
            ...
            cmd.CommandText = "SELECT * " +
                              "INTO MonitorQT_KMS " +
                              "FROM MonitorQT_KMS IN '" + Utx.Globale.Paths.DbLink + "' " +
                              "WHERE " + WhereDate + " AND " + WhereSub + " AND " + WhereProduttore
            cmd.ExecuteNonQuery()

            cmd.CommandText = "SELECT * " +
                              "INTO Incassi " +
                              "FROM Incassi IN '{0}' " +
                              "WHERE DataEffettoTitolo BETWEEN #{1:MM/dd/yyyy}# AND #{2:MM/dd/yyyy}#"
            cmd.CommandText = String.Format(cmd.CommandText, Utx.Globale.Paths.DbLink, dtpInizio.Value, dtpFine.Value)
            cmd.ExecuteNonQuery()
            '----------------------------------
    ...
    Private Function CommandStat(Tipo As Query) As String
        Select Case Tipo
            Case Query.QTPreviste
                CommandStat = "SELECT Count(*) FROM MonitorQT_KMS"
            Case Query.IncassiPrevisti
                CommandStat = "SELECT SUM(TotRataLordoNew) FROM MonitorQT_KMS"
            Case Query.QTNoVar
                CommandStat = "SELECT Count(*) " + _
                              "FROM Incassi i " + _
                              "INNER JOIN MonitorQT_KMS m ON i.Polizza = m.Polizza And " + _
    ...
    Private Sub CalcolaStatistiche2()
        ...
        Try
            ...
            cmd.CommandText = "SELECT * " + _
                              "INTO MonitorQT_KMS " + _
                              "FROM MonitorQT_KMS In '" + Utx.Globale.Paths.DbLink + "' " + _
                ...
                For nRow As Int16 = 0 To MaxRow
                    Select Case dt.Rows(nRow).Item("FspNew")
                        Case "Senza"
                            'non fare niente
                        Case "A", "B", "C"
                            TotAC = TotAC + dt.Rows(nRow).Item(nCol)
                        Case Is >= "D"
                            TotDJ = TotDJ + dt.Rows(nRow).Item(nCol)
                    End Select
                Next
    ...
    Private Sub ApriDettaglio(TabDefault As String)
        ...
        Using DettaglioArd As New FormArdKMS
    ...
    Private Sub dgv1_ColumnHeaderMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgv1.ColumnHeaderMouseClick
        ...
        Try
            ...
            FormFiltro.AppName = "MonitorQT_KMS"
