...
Public Class TextPrint
    ...
    Protected Overrides Sub OnBeginPrint(ev As Printing.PrintEventArgs)
        ' Run base code
    ...
    Protected Overrides Sub OnPrintPage(ev As Printing.PrintPageEventArgs)
        ...
        ev.Graphics.MeasureString(Mid(strText, UpgradeZeros(intCurrentChar)),
                                  Font,
        ...
        ev.Graphics.DrawString(Mid(strText, UpgradeZeros(intCurrentChar)),
                               Font,
                               Brushes.Black,
                               rectPrintingArea,
                               objSF)
    ...
    Public Function UpgradeZeros(Input As Integer) As Integer
        If Input = 0 Then
            Return 1
        Else
            Return Input
